...
def download_gfs_data():
    ...
    # url="https://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_0p25_1hr.pl?dir=%2Fgfs."+pdate+"%2F"+str(hour).zfill(2)+"%2Fatmos&file=gfs.t"+str(hour).zfill(2)+"z.pgrb2.0p25.f075&var_PRATE=on&var_UGRD=on&var_VGRD=on&lev_10_m_above_ground=on&lev_surface=on&subregion=&toplat=20&leftlon=72&rightlon=74&bottomlat=18"  
    # r = requests.get(url, verify=False,stream=True)
    # r.raw.decode_content = True
    # with open(f"gfs.t0{hour}z.pgrb2.0p25.f075", 'wb') as f:
    #     shutil.copyfileobj(r.raw, f)
        
    # url="https://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_0p25_1hr.pl?dir=%2Fgfs."+pdate+"%2F"+str(hour).zfill(2)+"%2Fatmos&file=gfs.t"+str(hour).zfill(2)+"z.pgrb2.0p25.f078&var_PRATE=on&var_UGRD=on&var_VGRD=on&lev_10_m_above_ground=on&lev_surface=on&subregion=&toplat=20&leftlon=72&rightlon=74&bottomlat=18"  
    # r = requests.get(url, verify=False,stream=True)
    # r.raw.decode_content = True
    # with open(f"gfs.t0{hour}z.pgrb2.0p25.f078", 'wb') as f:
    #     shutil.copyfileobj(r.raw, f)
        
    # url="https://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_0p25_1hr.pl?dir=%2Fgfs."+pdate+"%2F"+str(hour).zfill(2)+"%2Fatmos&file=gfs.t"+str(hour).zfill(2)+"z.pgrb2.0p25.f081&var_PRATE=on&var_UGRD=on&var_VGRD=on&lev_10_m_above_ground=on&lev_surface=on&subregion=&toplat=20&leftlon=72&rightlon=74&bottomlat=18"  
    # r = requests.get(url, verify=False,stream=True)
    # r.raw.decode_content = True
    # with open(f"gfs.t0{hour}z.pgrb2.0p25.f081", 'wb') as f:
    #     shutil.copyfileobj(r.raw, f)
        
    # url="https://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_0p25_1hr.pl?dir=%2Fgfs."+pdate+"%2F"+str(hour).zfill(2)+"%2Fatmos&file=gfs.t"+str(hour).zfill(2)+"z.pgrb2.0p25.f084&var_PRATE=on&var_UGRD=on&var_VGRD=on&lev_10_m_above_ground=on&lev_surface=on&subregion=&toplat=20&leftlon=72&rightlon=74&bottomlat=18"  
    # r = requests.get(url, verify=False,stream=True)
    # r.raw.decode_content = True
    # with open(f"gfs.t0{hour}z.pgrb2.0p25.f084", 'wb') as f:
    #     shutil.copyfileobj(r.raw, f)

    # url="https://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_0p25_1hr.pl?dir=%2Fgfs."+pdate+"%2F"+str(hour).zfill(2)+"%2Fatmos&file=gfs.t"+str(hour).zfill(2)+"z.pgrb2.0p25.f087&var_PRATE=on&var_UGRD=on&var_VGRD=on&lev_10_m_above_ground=on&lev_surface=on&subregion=&toplat=20&leftlon=72&rightlon=74&bottomlat=18"  
    # r = requests.get(url, verify=False,stream=True)
    # r.raw.decode_content = True
    # with open(f"gfs.t0{hour}z.pgrb2.0p25.f087", 'wb') as f:
    #     shutil.copyfileobj(r.raw, f)
        
    # url="https://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_0p25_1hr.pl?dir=%2Fgfs."+pdate+"%2F"+str(hour).zfill(2)+"%2Fatmos&file=gfs.t"+str(hour).zfill(2)+"z.pgrb2.0p25.f090&var_PRATE=on&var_UGRD=on&var_VGRD=on&lev_10_m_above_ground=on&lev_surface=on&subregion=&toplat=20&leftlon=72&rightlon=74&bottomlat=18"  
    # r = requests.get(url, verify=False,stream=True)
    # r.raw.decode_content = True
    # with open(f"gfs.t0{hour}z.pgrb2.0p25.f090", 'wb') as f:
    #     shutil.copyfileobj(r.raw, f)

    # url="https://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_0p25_1hr.pl?dir=%2Fgfs."+pdate+"%2F"+str(hour).zfill(2)+"%2Fatmos&file=gfs.t"+str(hour).zfill(2)+"z.pgrb2.0p25.f093&var_PRATE=on&var_UGRD=on&var_VGRD=on&lev_10_m_above_ground=on&lev_surface=on&subregion=&toplat=20&leftlon=72&rightlon=74&bottomlat=18"  
    # r = requests.get(url, verify=False,stream=True)
    # r.raw.decode_content = True
    # with open(f"gfs.t0{hour}z.pgrb2.0p25.f093", 'wb') as f:
    #     shutil.copyfileobj(r.raw, f)

    # url="https://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_0p25_1hr.pl?dir=%2Fgfs."+pdate+"%2F"+str(hour).zfill(2)+"%2Fatmos&file=gfs.t"+str(hour).zfill(2)+"z.pgrb2.0p25.f097&var_PRATE=on&var_UGRD=on&var_VGRD=on&lev_10_m_above_ground=on&lev_surface=on&subregion=&toplat=20&leftlon=72&rightlon=74&bottomlat=18"  
    # r = requests.get(url, verify=False,stream=True)
    # r.raw.decode_content = True
    # with open(f"gfs.t0{hour}z.pgrb2.0p25.f096", 'wb') as f:
    #     shutil.copyfileobj(r.raw, f)

    # url="https://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_0p25_1hr.pl?dir=%2Fgfs."+pdate+"%2F"+str(hour).zfill(2)+"%2Fatmos&file=gfs.t"+str(hour).zfill(2)+"z.pgrb2.0p25.f100&var_PRATE=on&var_UGRD=on&var_VGRD=on&lev_10_m_above_ground=on&lev_surface=on&subregion=&toplat=20&leftlon=72&rightlon=74&bottomlat=18"  
    # r = requests.get(url, verify=False,stream=True)
    # r.raw.decode_content = True
    # with open(f"gfs.t0{hour}z.pgrb2.0p25.f099", 'wb') as f:
    #     shutil.copyfileobj(r.raw, f)

    # url="https://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_0p25_1hr.pl?dir=%2Fgfs."+pdate+"%2F"+str(hour).zfill(2)+"%2Fatmos&file=gfs.t"+str(hour).zfill(2)+"z.pgrb2.0p25.f103&var_PRATE=on&var_UGRD=on&var_VGRD=on&lev_10_m_above_ground=on&lev_surface=on&subregion=&toplat=20&leftlon=72&rightlon=74&bottomlat=18"  
    # r = requests.get(url, verify=False,stream=True)
    # r.raw.decode_content = True
    # with open(f"gfs.t0{hour}z.pgrb2.0p25.f102", 'wb') as f:
    #     shutil.copyfileobj(r.raw, f)

    # url="https://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_0p25_1hr.pl?dir=%2Fgfs."+pdate+"%2F"+str(hour).zfill(2)+"%2Fatmos&file=gfs.t"+str(hour).zfill(2)+"z.pgrb2.0p25.f106&var_PRATE=on&var_UGRD=on&var_VGRD=on&lev_10_m_above_ground=on&lev_surface=on&subregion=&toplat=20&leftlon=72&rightlon=74&bottomlat=18"  
    # r = requests.get(url, verify=False,stream=True)
    # r.raw.decode_content = True
    # with open(f"gfs.t0{hour}z.pgrb2.0p25.f105", 'wb') as f:
    #     shutil.copyfileobj(r.raw, f)

    # url="https://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_0p25_1hr.pl?dir=%2Fgfs."+pdate+"%2F"+str(hour).zfill(2)+"%2Fatmos&file=gfs.t"+str(hour).zfill(2)+"z.pgrb2.0p25.f109&var_PRATE=on&var_UGRD=on&var_VGRD=on&lev_10_m_above_ground=on&lev_surface=on&subregion=&toplat=20&leftlon=72&rightlon=74&bottomlat=18"  
    # r = requests.get(url, verify=False,stream=True)
    # r.raw.decode_content = True
    # with open(f"gfs.t0{hour}z.pgrb2.0p25.f108", 'wb') as f:
    #     shutil.copyfileobj(r.raw, f)

    # url="https://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_0p25_1hr.pl?dir=%2Fgfs."+pdate+"%2F"+str(hour).zfill(2)+"%2Fatmos&file=gfs.t"+str(hour).zfill(2)+"z.pgrb2.0p25.f110&var_PRATE=on&var_UGRD=on&var_VGRD=on&lev_10_m_above_ground=on&lev_surface=on&subregion=&toplat=20&leftlon=72&rightlon=74&bottomlat=18"  
    # r = requests.get(url, verify=False,stream=True)
    # r.raw.decode_content = True
    # with open(f"gfs.t0{hour}z.pgrb2.0p25.f111", 'wb') as f:
    #     shutil.copyfileobj(r.raw, f)

    # url="https://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_0p25_1hr.pl?dir=%2Fgfs."+pdate+"%2F"+str(hour).zfill(2)+"%2Fatmos&file=gfs.t"+str(hour).zfill(2)+"z.pgrb2.0p25.f113&var_PRATE=on&var_UGRD=on&var_VGRD=on&lev_10_m_above_ground=on&lev_surface=on&subregion=&toplat=20&leftlon=72&rightlon=74&bottomlat=18"  
    # r = requests.get(url, verify=False,stream=True)
    # r.raw.decode_content = True
    # with open(f"gfs.t0{hour}z.pgrb2.0p25.f114", 'wb') as f:
    #     shutil.copyfileobj(r.raw, f)

    # url="https://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_0p25_1hr.pl?dir=%2Fgfs."+pdate+"%2F"+str(hour).zfill(2)+"%2Fatmos&file=gfs.t"+str(hour).zfill(2)+"z.pgrb2.0p25.f116&var_PRATE=on&var_UGRD=on&var_VGRD=on&lev_10_m_above_ground=on&lev_surface=on&subregion=&toplat=20&leftlon=72&rightlon=74&bottomlat=18"  
    # r = requests.get(url, verify=False,stream=True)
    # r.raw.decode_content = True
    ...
    # url="https://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_0p25_1hr.pl?dir=%2Fgfs."+pdate+"%2F"+str(hour).zfill(2)+"%2Fatmos&file=gfs.t"+str(hour).zfill(2)+"z.pgrb2.0p25.f119&var_PRATE=on&var_UGRD=on&var_VGRD=on&lev_10_m_above_ground=on&lev_surface=on&subregion=&toplat=20&leftlon=72&rightlon=74&bottomlat=18"  
    # r = requests.get(url, verify=False,stream=True)
    # r.raw.decode_content = True
    # with open(f"gfs.t0{hour}z.pgrb2.0p25.f120", 'wb') as f:
    #     shutil.copyfileobj(r.raw, f)
        
    # url="https://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_0p25_1hr.pl?dir=%2Fgfs."+pdate+"%2F"+str(hour).zfill(2)+"%2Fatmos&file=gfs.t"+str(hour).zfill(2)+"z.pgrb2.0p25.f122&var_PRATE=on&var_UGRD=on&var_VGRD=on&lev_10_m_above_ground=on&lev_surface=on&subregion=&toplat=20&leftlon=72&rightlon=74&bottomlat=18"  
    # r = requests.get(url, verify=False,stream=True)
    # r.raw.decode_content = True
